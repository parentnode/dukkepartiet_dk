	...
	*/
	function __construct() {
		...
		$this->addToModel("name", array(
			...
			"required" => true,
			"unique" => $this->db,
			"hint_message" => "Every video deserves a name - just write a few words, which uniquely identifies the video", 
		...
		$this->addToModel("description", array(
			...
			"label" => "Description",
			"required" => true,
			"hint_message" => "Describe the video",
		...
		$this->addToModel("main", array(
			...
			"hint_message" => "Add video images here. Use png or jpg in 480x270.",

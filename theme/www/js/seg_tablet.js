...
/*m-video.js*/
Util.Modules["video"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
...
/*m-bill.js*/
Util.Modules["bill"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
...
/*m-carousel.js*/
Util.Modules["carousel"] = new function() {
...
/*m-action.js*/
Util.Modules["action"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
...
/*m-mask.js*/
Util.Modules["mask"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
...
/*m-help.js*/
Util.Modules["help"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
			if(this.offsetHeight < page.browser_h) {
				u.as(this, "height", (page.browser_h-160)+"px");
...
/*m-primeminister.js*/
Util.Modules["primeminister"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
...
/*m-program.js*/
Util.Modules["program"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
